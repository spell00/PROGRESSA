...
def analyse_results(args):
    ...
    for method in sorted(os.listdir(args.results_path)):
        ...
        if os.path.isdir(method_path):
            ...
            intervals_file = {x: open(f'{method_path}/intervals_{x}.tsv', 'w') for x in ['o69', 'u69', 'sex0', 'sex1']}
            avg_scores_files = {x: open(f'{method_path}/avg_scores_{x}.tsv', 'w') for x in ['o69', 'u69', 'sex0', 'sex1']}
            ...
            for v in predictions.keys():
                ...
                for i in range(len(predictions[v])):
                    ...
                    these_real_values = {'o69': [], 'u69': [], 'sex0': [], 'sex1': []}
                    these_predictions = {'o69': [], 'u69': [], 'sex0': [], 'sex1': []}
                    these_raw_predictions = {'o69': [], 'u69': [], 'sex0': [], 'sex1': []}
                ...
                for k in scores.keys():
                    ...
                    for s in range(len(scores_names)):
                        conf_interval = stats.bootstrap((scores[k][:, s],), np.mean, method="basic")
