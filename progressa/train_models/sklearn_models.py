    ...
    def train(self):
        for i in range(self.args.n_splits):
            ...
            for v in range(self.n_max_visits):
                ...
                if len(v_ids) > 0:
                    # print(v, max(v_ids), i, len(predictions), len(self.predictions_values_per_visit),
                    #       len(self.predictions_values_per_visit[v]))
            ...
            # print(self.predictions_raw_values_per_visit)
            # self.save_indices()
